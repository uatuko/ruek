...
const (
	Principals_Create_FullMethodName   = "/sentium.api.v1.Principals/Create"
	Principals_Delete_FullMethodName   = "/sentium.api.v1.Principals/Delete"
	Principals_List_FullMethodName     = "/sentium.api.v1.Principals/List"
	Principals_Retrieve_FullMethodName = "/sentium.api.v1.Principals/Retrieve"
	Principals_Update_FullMethodName   = "/sentium.api.v1.Principals/Update"
)
...
type PrincipalsClient interface {
	Create(ctx context.Context, in *PrincipalsCreateRequest, opts ...grpc.CallOption) (*Principal, error)
	...
	Retrieve(ctx context.Context, in *PrincipalsRetrieveRequest, opts ...grpc.CallOption) (*Principal, error)
	Update(ctx context.Context, in *PrincipalsUpdateRequest, opts ...grpc.CallOption) (*Principal, error)
}
...
func (c *principalsClient) Create(ctx context.Context, in *PrincipalsCreateRequest, opts ...grpc.CallOption) (*Principal, error) {
	out := new(Principal)
...
func (c *principalsClient) Retrieve(ctx context.Context, in *PrincipalsRetrieveRequest, opts ...grpc.CallOption) (*Principal, error) {
	out := new(Principal)
...
func (c *principalsClient) Update(ctx context.Context, in *PrincipalsUpdateRequest, opts ...grpc.CallOption) (*Principal, error) {
	out := new(Principal)
...
type PrincipalsServer interface {
	Create(context.Context, *PrincipalsCreateRequest) (*Principal, error)
	...
	Retrieve(context.Context, *PrincipalsRetrieveRequest) (*Principal, error)
	Update(context.Context, *PrincipalsUpdateRequest) (*Principal, error)
...
func (UnimplementedPrincipalsServer) Create(context.Context, *PrincipalsCreateRequest) (*Principal, error) {
...
func (UnimplementedPrincipalsServer) Retrieve(context.Context, *PrincipalsRetrieveRequest) (*Principal, error) {
	return nil, status.Errorf(codes.Unimplemented, "method Retrieve not implemented")
}
func (UnimplementedPrincipalsServer) Update(context.Context, *PrincipalsUpdateRequest) (*Principal, error) {
...
var Principals_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "sentium.api.v1.Principals",
	...
	Metadata: "sentium/api/v1/principals.proto",
}
