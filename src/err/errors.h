...
using DatastoreInvalidRbacPolicyOrPrincipal = basic_error<"gk:1.4.3.400", "Invalid rbac policy or principal">;
using DatastoreDuplicateRbacPolicyPrincipal = basic_error<"gk:1.4.4.409", "Duplicate rbac policy principal">;
