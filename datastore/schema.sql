create table if not exists acl-policies (
	_id   text    not null,
...
create table if not exists collections_access-policies (
	...
	constraint "collections_access-policies.pkey" primary key (identity_id, policy_id),
...
create table if not exists collections_rbac-policies (
	...
	constraint "collections_rbac-policies.pkey" primary key (identity_id, policy_id),
